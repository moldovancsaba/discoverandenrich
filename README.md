...
On the OpenClaw host it is **always on** as a launchd service and reachable at
`http://localhost:3000/openclaw`; nothing needs to be launched first, and running `npm run dev`
by hand there is not how to open it. How to check it, restart it and read its logs lives in one
place: `/Users/Shared/Projects/OpenClaw/tools/openclaw-admin/README.md`.
